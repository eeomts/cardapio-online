...
use assets\vendor\bacon\baconuse assets\vendor\bacon\baconuse assets\vendor\bacon\baconuse BaconQrCode\Common\BitArray;
use code\src\Common\CharacterSetEci;
use BaconQrCode\Common\ErrorCorrectionLevel;
use BaconQrCode\Common\Mode;
use BaconQrCode\Common\ReedSolomonCodec;
use code\src\Common\Version;
use code\src\Exception\WriterException;
use SplFixedArray;
...
final class Encoder
{
     ...
     *
     * @throws code\src\Exception\WriterException if data is too big
     */
     ...
     *
     * @throws code\src\Exception\WriterException if data bits cannot fit in the QR code
     * @throws code\src\Exception\WriterException if bits size does not equal the capacity
     */
     ...
     *
     * @return int[]
     * @throws code\src\Exception\WriterException if block ID is too large
     * @throws code\src\Exception\WriterException if EC bytes mismatch
     * @throws code\src\Exception\WriterException if RS blocks mismatch
     * @throws code\src\Exception\WriterException if total bytes mismatch
     */
     ...
     *
     * @throws code\src\Exception\WriterException if number of bits and data bytes does not match
     * @throws code\src\Exception\WriterException if data bytes does not match offset
     * @throws code\src\Exception\WriterException if an interleaving error occurs
     */
     ...
     *
     * @throws code\src\Exception\WriterException if num letters is bigger than expected
     */
     ...
     *
     * @throws code\src\Exception\WriterException if an invalid mode was supplied
     */
     ...
     *
     * @throws code\src\Exception\WriterException if an invalid alphanumeric code was found
     */
     ...
     *
     * @throws code\src\Exception\WriterException if content cannot be encoded to target encoding
     */
     ...
     *
     * @throws code\src\Exception\WriterException if content does not seem to be encoded in SHIFT-JIS
     * @throws code\src\Exception\WriterException if an invalid byte sequence occurs
     */
