...
final class ReedSolomonCodec
{
    ...
    /**
     * @throws code\src\Exception\InvalidArgumentException if symbol size ist not between 0 and 8
     * @throws code\src\Exception\InvalidArgumentException if first root is invalid
     * @throws code\src\Exception\InvalidArgumentException if num roots is invalid
     * @throws code\src\Exception\InvalidArgumentException if padding is invalid
