...
use code\src\Exception\InvalidArgumentException;
use SplFixedArray;
...
class BitMatrix
{
    ...
    /**
     * @throws code\src\Exception\InvalidArgumentException if a dimension is smaller than zero
     */
     ...
     *
     * @throws code\src\Exception\InvalidArgumentException if left or top are negative
     * @throws code\src\Exception\InvalidArgumentException if width or height are smaller than 1
     * @throws code\src\Exception\InvalidArgumentException if region does not fit into the matix
     */
