...
final class Cmyk implements ColorInterface
{
    ...
    {
        if ($cyan < 0 || $cyan > 100) {
            throw new code\src\Exception\InvalidArgumentException('Cyan must be between 0 and 100');
        }

        if ($magenta < 0 || $magenta > 100) {
            throw new code\src\Exception\InvalidArgumentException('Magenta must be between 0 and 100');
        }

        if ($yellow < 0 || $yellow > 100) {
            throw new code\src\Exception\InvalidArgumentException('Yellow must be between 0 and 100');
        }

        if ($black < 0 || $black > 100) {
            throw new code\src\Exception\InvalidArgumentException('Black must be between 0 and 100');
        }
