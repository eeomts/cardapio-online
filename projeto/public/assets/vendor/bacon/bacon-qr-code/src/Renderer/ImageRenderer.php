...
use code\src\Renderer\Image\ImageBackEndInterface;
use BaconQrCode\Renderer\Path\Path;
use code\src\Renderer\RendererStyle\EyeFill;
...
final class ImageRenderer implements RendererInterface
{
    ...
    /**
     * @var code\src\Renderer\Image\ImageBackEndInterface
     */
    ...
    /**
     * @throws code\src\Exception\InvalidArgumentException if matrix width doesn't match height
     */
