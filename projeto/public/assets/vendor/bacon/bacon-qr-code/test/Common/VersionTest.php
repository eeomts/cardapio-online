...
class VersionTest extends TestCase
{
    ...
    {
        $version = code\src\Common\Version::getVersionForNumber($versionNumber);
    ...
    public function testGetProvisionalVersionForDimension(int $versionNumber, int $dimension) : void
    {
        $this->assertSame(
            $versionNumber,
            code\src\Common\Version::getProvisionalVersionForDimension($dimension)->getVersionNumber()
        );
    }
    ...
    {
        $version = code\src\Common\Version::decodeVersionInformation($mask);
        $this->assertNotNull($version);
