...
use assets\vendor\khanamiryan\qrcodeuse assets\vendor\khanamiryan\qrcodeuse decoder\lib\ChecksumException;
use decoder\lib\Common\BitMatrix;
use decoder\lib\Common\Reedsolomon\GenericGF;
...
final class Decoder
{
	 ...
	 * @throws decoder\lib\ChecksumException if error correction fails
	 */
	...
	/**
	 * <p>Decodes a QR Code represented as a {@link decoder\lib\Common\BitMatrix}. A 1 or "true" is taken to mean a black module.</p>
	 *
	 * @param decoder\lib\Common\BitMatrix $bits booleans representing white/black QR Code modules
	 * @param           decoding $hints hints that should be used to influence decoding
	 *
	 * @return text and bytes encoded within the QR Code
	 * @throws FormatException if the QR Code cannot be decoded
