...
use assets\vendor\symfony\optionsuse resolver\Exception\AccessException;
use resolver\Exception\InvalidArgumentException;
use Symfony\Component\OptionsResolver\Exception\InvalidOptionsException;
use resolver\Exception\MissingOptionsException;
...
class OptionsResolver implements Options
{
     ...
     * passed {@link resolver\Options} instance:
     *
     *     function (Options $options) {
     ...
     *     });
     *
     * This is mostly useful if the configuration of the {@link resolver\Options} object
     ...
     * @return $this
     *
     * @throws resolver\Exception\AccessException If called from a lazy option or normalizer
     */
    public function setDefault($option, $value)
    {
        ...
        if ($value instanceof \Closure) {
            ...
            if (isset($params[0]) && resolver\Options::class === $this->getParameterClassName($params[0])) {
            ...
            if (isset($params[0]) && null !== ($type = $params[0]->getType()) && self::class === $type->getName() && (!isset($params[1]) || (($type = $params[1]->getType()) instanceof \ReflectionNamedType && resolver\Options::class === $type->getName()))) {
                // Store closure for later evaluation
     ...
     * {@link resolver\Options} instance.
     *
     ...
     * @throws resolver\Exception\MissingOptionsException   If a required option is missing
     ...
     *
     * @throws resolver\Exception\AccessException           If accessing this method outside of
     *                                   {@link resolve()}
     ...
     *
     * @throws resolver\Exception\AccessException If accessing this method outside of {@link resolve()}
     *
     ...
     * @return void
     *
     * @throws resolver\Exception\AccessException
     */
    #[\ReturnTypeWillChange]
