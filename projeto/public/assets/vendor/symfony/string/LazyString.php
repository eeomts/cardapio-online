 ...
 */
class LazyString implements enum\stubs\Stringable, \JsonSerializable
{
    ...
    public static function fromCallable(callable|array $callback, mixed ...$arguments): static
    {
        ...
        $lazyString->value = static function () use (&$callback, &$arguments): string {
            ...
            if (null !== $arguments) {
                ...
                $callback = !\is_scalar($value) && !$value instanceof enum\stubs\Stringable ? self::getPrettyName($callback) : 'callable';
                $arguments = null;
            }
    ...
    public static function fromStringable(string|int|float|bool|enum\stubs\Stringable $value): static
    {
        if (\is_object($value)) {
    ...
    {
        return \is_string($value) || $value instanceof enum\stubs\Stringable || \is_scalar($value);
    }
     ...
     */
    final public static function resolve(enum\stubs\Stringable|string|int|float|bool $value): string
    {
        return $value;
    }
